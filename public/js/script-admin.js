$( document ).ready(function() {
	...
	var newColHtml = '<div class="btn-group pull-right">' +
		'<button id="bEdit" type="button" class="btn btn-sm btn-success"  onclick="payOk(this);">' +
		'€€ OK' +
		'</button>' +
		'<button id="bElim" type="button" class="btn btn-sm btn-danger"  onclick="payNo(this);">' +
		'€€' +
		'<button id="bElim" type="button" class="btn btn-sm btn-success"  onclick="certifOk(this);">' +
		'Certif OK' +
		'<button id="bElim" type="button" class="btn btn-sm btn-danger"  onclick="certifNo(this);">' +
		'Certif' +
		'</button>'+'</div>';
